...
def _pretty_console_event(event: Mapping[str, Any], color: bool = False) -> str:
    ...
    aliases = {
        ...
        "task_transition_pending": "next_goal_offer",
        ...
        "canonicalized_provider_goal_count": "goal_aliases",
        "rejected_provider_goal_count": "invalid_goals",
        "rejected_provider_skill_count": "invalid_skills",
        "conversation_act": "act",
        "active_goal_relation": "relation",
        "slot_update_fields": "slots",
        "rejected_slot_update_count": "invalid_slots",
    }
    keys = (
        "configured_provider",
        "provider",
        ...
        "goals",
        "canonicalized_provider_goal_count",
        "rejected_provider_goal_count",
        "rejected_provider_skill_count",
        "conversation_act",
        "active_goal_relation",
        "slot_update_fields",
        "rejected_slot_update_count",
        "skill",
        "selected_skill",
        "skill_version",
        "skill_artifact_hash",
