...
After shared conversation policy confirms the member wants a human, collect a
concise reason. Derive the queue from that reason when it is clear; otherwise
ask the member to choose insurance, banking, or advice. Transfer minimized
context rather than the full transcript.
